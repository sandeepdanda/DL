...
# FakeNewsNet Dataset
gossipcop_fake = pd.read_csv('FakeNewsNetdataset/gossipcop_fake.csv')
gossipcop_real = pd.read_csv('FakeNewsNetdataset/gossipcop_real.csv')
politifact_fake = pd.read_csv('FakeNewsNetdataset/politifact_fake.csv')
politifact_real = pd.read_csv('FakeNewsNetdataset/politifact_real.csv')
...
combined_data = pd.concat([gossipcop_fake, gossipcop_real, politifact_fake, politifact_real], axis=0, ignore_index=True, sort=False)
...
columns_to_drop = ['id', 'news_url', 'tweet_ids']
